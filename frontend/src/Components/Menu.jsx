...
const Menu = () => {
  ...
  return (
    <div>
      ...
      {/* create menu modal */}
      {showMenuCreate && (
        <div className="create-modal" onClick={() => setShowMenuCreate(false)}>
          <div className="create-content" onClick={(e) => e.stopPropagation()}>
      ...
      {/* add item modal */}
      {showAddModal && (
        <div className="create-modal" onClick={() => setShowAddModal(false)}>
          <div className="create-content" onClick={(e) => e.stopPropagation()}>
            <h3>Add Food Item</h3>
